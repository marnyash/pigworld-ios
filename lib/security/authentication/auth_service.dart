...
class AuthService {
	...
	Future<void> setRememberMe(bool value) => _storage.write(key: rememberMeKey, value: '$value');
	Future<bool> get rememberMe async => (await _storage.read(key: rememberMeKey)) == 'true';

	Future<void> setSessionTimestamp(DateTime timestamp) =>
			_storage.write(key: sessionTimestampKey, value: timestamp.toIso8601String());
